...
const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=100089571009398&mibextid=PtKPJ9',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/partyandgifthn?igsh=bjZ3N2FxNjdqNzc=',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-10 xl:mt-0">
              <h3 className="text-sm font-semibold leading-6 text-white">Suscríbase a nuestro boletín</h3>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2014 Tu empresa, Inc. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
